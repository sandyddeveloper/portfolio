  ...
  return (
    <footer
      className={`relative w-full overflow-hidden border-t mt-32 transition-all duration-300 ${
        theme === 'dark'
          ? 'border-slate-800/80 bg-slate-950/95 text-slate-300 shadow-2xl shadow-cyan-950/20'
    ...
    >
      ...
      <div className="pointer-events-none absolute -bottom-10 left-1/2 -translate-x-1/2 select-none text-[120px] sm:text-[140px] font-black uppercase tracking-tighter opacity-[0.03] whitespace-nowrap">
      ...
      <div className="relative z-10 mx-auto w-full max-w-[1600px] px-6 sm:px-12 lg:px-16 py-12 sm:py-16 space-y-12">
        ...
        <div className="flex flex-col gap-6 lg:flex-row lg:items-center lg:justify-between border-b border-slate-800/50 pb-8">
          <div className="space-y-2">
            <div className="flex items-center gap-3">
              <div className="flex h-10 w-10 items-center justify-center rounded-2xl bg-cyan-500/10 border border-cyan-500/30 text-cyan-400 font-mono font-bold shadow-md shadow-cyan-500/10">
          ...
          <div className="flex flex-wrap items-center gap-3">
            ...
            >
              ...
              <kbd className="rounded bg-slate-800/80 px-1.5 py-0.5 text-[10px] font-mono text-cyan-300 border border-slate-700">
                Ctrl K
              </kbd>
            </button>
            ...
            <button
              onClick={scrollToTop}
              className="flex items-center gap-2 rounded-xl bg-cyan-500/10 border border-cyan-500/30 px-4 py-2.5 text-xs font-bold text-cyan-400 hover:bg-cyan-500/20 transition-all cursor-pointer group shadow-sm shadow-cyan-500/10"
            >
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2 text-xs">
              <button
                ...
                className="flex items-center gap-2 text-slate-300 hover:text-cyan-400 transition-colors group cursor-pointer"
              >
              ...
              {[
                ...
                <li key={item.name}>
                  <button
                    ...
                    className="text-slate-400 hover:text-cyan-300 transition-colors flex items-center gap-1.5 cursor-pointer"
                  >
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-2 gap-2">
              ...
              <div className={`rounded-xl border p-3 ${
                ...
                <p className="text-sm font-bold text-cyan-400 font-mono">18ms</p>
              </div>

              <div className={`rounded-xl border p-3 ${
                theme === 'dark' ? 'border-slate-800 bg-slate-900/60' : 'border-slate-200 bg-slate-50'
              }`}>
                <p className="text-[10px] font-mono text-slate-500 uppercase">Repos</p>
                <p className="text-sm font-bold text-white font-mono">41+</p>
              </div>

              <div className={`rounded-xl border p-3 ${
                theme === 'dark' ? 'border-slate-800 bg-slate-900/60' : 'border-slate-200 bg-slate-50'
              }`}>
                <p className="text-[10px] font-mono text-slate-500 uppercase">Daily Evts</p>
        ...
        <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between border-t border-slate-800/50 pt-6 text-[11px] text-slate-500 font-mono">
          <div>
          ...
          <div className="flex items-center gap-4 flex-wrap">
            ...
            <span>•</span>
            <span className="text-cyan-400">v3.4 Production Ready</span>
          </div>
        </div>
      </div>
    </footer>
