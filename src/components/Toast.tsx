        ...
        <AnimatePresence>
          {toasts.map((toast) => (
            <motion.div
              ...
              className="pointer-events-auto flex items-start gap-3 rounded-2xl border border-slate-700/80 bg-slate-900/95 p-4 shadow-2xl shadow-cyan-500/10 backdrop-blur-xl text-slate-100"
            >
